...
export const createTagAction = createAction({
    ...
    description: 'Create a new custom tag, or rename / re-style an existing one (pass the tag ID to edit).',
    props: {
        ...
        badge: Property.StaticDropdown<'primary' | 'secondary' | 'success' | 'danger' | 'warning' | 'info' | 'light' | 'dark'>({
